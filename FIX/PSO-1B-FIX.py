...
xi = {
    "x1" : random.uniform(1/2,4),
    "x2" : random.uniform(1/2,4),
    "x3" : random.uniform(1/2,4),
    "x4" : random.uniform(1/2,4),
    "x5" : random.uniform(1/2,4),
    "x6" : random.uniform(1/2,4),
    "x7" : random.uniform(1/2,4),
    "x8" : random.uniform(1/2,4),
    "x9" : random.uniform(1/2,4),
    "x10": random.uniform(1/2,4)
}
