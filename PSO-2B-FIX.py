...
for index in range(n):
    print("\033[0;34m"+f"iterasi ke-{index+1}"+"\033[0m")
    print(f"nilai (x1,y1): ({xi['x1']},{yi['y1']})")
    print(f"nilai (x2,y2): ({xi['x2']},{yi['y2']})")
    print(f"nilai (x3,y3): ({xi['x3']},{yi['y3']})")
    print(f"nilai (x4,y4): ({xi['x4']},{yi['y4']})")
    print(f"nilai (x5,y5): ({xi['x5']},{yi['y5']})")
    print(f"nilai (x6,y6): ({xi['x6']},{yi['y6']})")
    print(f"nilai (x7,y7): ({xi['x7']},{yi['y7']})")
    print(f"nilai (x8,y8): ({xi['x8']},{yi['y8']})")
    print(f"nilai (x9,y9): ({xi['x9']},{yi['y9']})")
    print(f"nilai (x10,y10): ({xi['x10']},{yi['y10']})")
    print()
    print(f"nilai f(x1,y1): {func(xi['x1'],yi['y1'])}")
    print(f"nilai f(x2,y2): {func(xi['x2'],yi['y2'])}")
    print(f"nilai f(x3,y3): {func(xi['x3'],yi['y3'])}")
    print(f"nilai f(x4,y4): {func(xi['x4'],yi['y4'])}")
    print(f"nilai f(x5,y5): {func(xi['x5'],yi['y5'])}")
    print(f"nilai f(x6,y6): {func(xi['x6'],yi['y6'])}")
    print(f"nilai f(x7,y7): {func(xi['x7'],yi['y7'])}")
    print(f"nilai f(x8,y8): {func(xi['x8'],yi['y8'])}")
    print(f"nilai f(x9,y9): {func(xi['x9'],yi['y9'])}")
    print(f"nilai f(x10,y10): {func(xi['x10'],yi['y10'])}")
    print()
    print("\033[92m"+f"Nilai Gbest: ({Gbestx}, {Gbesty})"+"\033[0m")
    print("\033[92m"+f"Nilai minimum f(x,y): {func(Gbestx,Gbesty)}"+"\033[0m")
    print()
